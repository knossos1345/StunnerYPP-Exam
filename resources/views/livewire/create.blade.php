                ...
                <div class="flex flex-col sm:flex-row items-center">
                    ...
                    <div class="w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0"></div>
                        ...
                        <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                            ...
                            <button wire:click.prevent="store()" class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500">Save</button>
                        </div>
            </div>
        </form>
    </div>
